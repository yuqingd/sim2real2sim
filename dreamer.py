...
def define_config():
  ...
  # Sim2real transfer
  config.real_world_prob = False  # fraction of samples trained on which are from the real world (probably involves oversampling real-world samples)
...
def main(config):
  ...
  if not config.real_world_prob or config.real_world_prob > 0:
