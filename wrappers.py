...
class Kitchen:
  ...
  def step(self, action):
    ...
    ikresult = qpos_from_site_pose(physics, self.end_effector_name, target_pos=xyz_pos, joint_names=joint_names, max_steps=10)  # TODO: possibly specify which joints to move to reach this??
    qpos = ikresult.qpos
